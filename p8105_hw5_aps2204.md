...
Based on this plot, is apparent that the experimental arm of the study
has higher observed values on average than the control arm. Further, the
experimental arm appears to have an overall upward trend over time,
while the control arm appears to have an overall downward trend over
time. The spread of observations in both arms appears to decrease
between weeks 7 and 8, though this may simply be a product of how the
data is not displayed after week 8. The experimental arm appears to
display the same amount of spread as the control arm.
